...
class WomensFashionPage extends StatefulWidget {
  const WomensFashionPage({super.key});

  @override
  State<WomensFashionPage> createState() => _WomensFashionPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Kategori: Fesyen Wanita'),
      ),
