...
class BeautySkincarePage extends StatefulWidget {
  const BeautySkincarePage({super.key});

  @override
  State<BeautySkincarePage> createState() => _BeautySkincarePageState();
}

class _BeautySkincarePageState extends State<BeautySkincarePage> {
  ...
  Future<List<DocumentSnapshot>> _fetchProducts() async {
    ...
    QuerySnapshot<Map<String, dynamic>> querySnapshot =
        await FirebaseFirestore.instance
            ...
            .where('category', isEqualTo: "Beauty & Personal Care")
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Kategori: Kecantikan'),
      ),
